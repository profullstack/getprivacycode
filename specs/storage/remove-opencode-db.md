# Remove `packages/privacycode/src/storage/db.ts`

## Goal

Remove all production usages of the legacy `packages/privacycode/src/storage/db.ts` module.
...
Production imports from `packages/privacycode/src/storage/db.ts` are concentrated in 22 source files:

- `packages/privacycode/src/account/repo.ts`
- `packages/privacycode/src/cli/cmd/db.ts`
- `packages/privacycode/src/cli/cmd/import.ts`
- `packages/privacycode/src/cli/cmd/stats.ts`
- `packages/privacycode/src/control-plane/workspace.ts`
- `packages/privacycode/src/index.ts`
- `packages/privacycode/src/node.ts`
- `packages/privacycode/src/permission/index.ts`
- `packages/privacycode/src/project/project.ts`
- `packages/privacycode/src/server/projectors.ts`
- `packages/privacycode/src/server/routes/instance/httpapi/handlers/sync.ts`
- `packages/privacycode/src/server/shared/fence.ts`
- `packages/privacycode/src/session/message-v2.ts`
- `packages/privacycode/src/session/projectors.ts`
- `packages/privacycode/src/session/prompt.ts`
- `packages/privacycode/src/session/session.ts`
- `packages/privacycode/src/session/todo.ts`
- `packages/privacycode/src/share/share-next.ts`
- `packages/privacycode/src/storage/db.ts`
- `packages/privacycode/src/sync/index.ts`
- `packages/privacycode/src/worktree/index.ts`
...
Status: Completed. Startup, the public node export, and database CLI tooling no longer import the legacy opencode database wrapper; `packages/privacycode/src/storage/db.ts` has been deleted.
...
All migration groups are complete or superseded. `packages/privacycode/src/storage/db.ts` has been deleted.
...
- Existing schema ownership remains in `packages/core/src/**/*.sql.ts`; do not move table definitions back into `packages/privacycode`.

## Verification Commands

- `rg "@/storage/db|./storage/db|Database\.(use|transaction|effect|Client|getPath)|\bTxOrDb\b|\bTransaction\b" packages/privacycode/src`
- `bun typecheck` from `packages/privacycode`
- Relevant package tests from `packages/privacycode`, not the repo root
