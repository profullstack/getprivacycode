...
class Database extends Context.Service<Database, DatabaseShape>()("@privacycode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@privacycode/example/UserStore") {
