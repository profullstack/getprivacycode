...
export const TypeId: TypeId = "~@privacycode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@privacycode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@privacycode-ai/effect-sqlite-node/NodeSqliteClient")
