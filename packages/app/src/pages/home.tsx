import type { Session } from "@privacycode-ai/sdk/v2/client"
import {
  type ComponentProps,
  createEffect,
  createMemo,
...
import { Logo } from "@privacycode-ai/ui/logo"
import { Spinner } from "@privacycode-ai/ui/spinner"
import { ScrollView } from "@privacycode-ai/ui/scroll-view"
import { ProjectAvatar } from "@privacycode-ai/ui/v2/project-avatar-v2"
...
import { base64Encode } from "@privacycode-ai/core/util/encode"
...
import { Binary } from "@privacycode-ai/core/util/binary"
import { ServerRowMenu } from "@/components/server/server-row-menu"
import { ServerHealthIndicator } from "@/components/server/server-row"
import { type ServerHealth } from "@/utils/server-health"
import { Persist, persisted } from "@/utils/persist"
import { useMarked } from "@privacycode-ai/ui/context/marked"
import { preloadMarkdown } from "@privacycode-ai/session-ui/markdown-cache"
      ...
      >
        <div class="mx-auto grid min-h-full w-full max-w-[1080px] grid-rows-[auto_minmax(0,1fr)_auto] gap-4 px-3 lg:grid-cols-[280px_minmax(0,720px)] lg:grid-rows-1 lg:gap-8 lg:px-6">
          <HomeProjectColumn
            ...
            openHelp={() => platform.openLink("https://privacycode.ai/desktop-feedback")}
            language={language}
            onWheel={(event) => {
