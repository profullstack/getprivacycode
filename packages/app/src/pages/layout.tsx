...
import { Session } from "@privacycode-ai/sdk/v2/client"
...
import { toaster } from "@privacycode-ai/ui/toast"
...
import { retry } from "@privacycode-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@privacycode-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://privacycode.ai/desktop-feedback")}
      renderPanel={() =>
