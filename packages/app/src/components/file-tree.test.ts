...
beforeAll(async () => {
  ...
  mock.module("@privacycode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@privacycode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@privacycode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@privacycode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
