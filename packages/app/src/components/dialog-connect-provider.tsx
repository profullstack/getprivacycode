import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@privacycode-ai/sdk/v2/client"
...
import { List, type ListRef } from "@privacycode-ai/ui/list"
import { ProviderIcon } from "@privacycode-ai/ui/provider-icon"
import { Spinner } from "@privacycode-ai/ui/spinner"
import { Tag } from "@privacycode-ai/ui/tag"
import { TextField } from "@privacycode-ai/ui/text-field"
import { ButtonV2 } from "@privacycode-ai/ui/v2/button-v2"
import { DialogBody, DialogHeader, DialogTitle, DialogV2 } from "@privacycode-ai/ui/v2/dialog-v2"
import { TextInputV2 } from "@privacycode-ai/ui/v2/text-input-v2"
                  ...
                  <For each={group.items()}>
                    {(provider) => (
                      ...
                      >
                        ...
                        <Show when={provider.id === "opencode" || provider.id === }>
        ...
        <Switch>
          <Match when={provider().id === "opencode"}>
            <div class="flex flex-col gap-4">
              ...
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.opencodeZen.visit.prefix")}
                <Link href="https://privacycode.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.opencodeZen.visit.link")}
                </Link>
                {language.t("provider.connect.opencodeZen.visit.suffix")}
              </div>
