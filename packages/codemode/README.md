...
{
  "dependencies": {
    "@privacycode-ai/codemode": "workspace:*"
  }
}
```
...
```ts
import { CodeMode, Tool } from "@privacycode-ai/codemode"
...
```ts
import { CodeMode, OpenAPI } from "@privacycode-ai/codemode"
...
```ts
import { toolError } from "@privacycode-ai/codemode"
