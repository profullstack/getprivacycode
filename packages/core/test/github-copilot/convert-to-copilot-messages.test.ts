import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@privacycode-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
