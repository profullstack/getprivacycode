...
import type { Plugin as PluginRuntime } from "@privacycode-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/v2/Plugin") {}
