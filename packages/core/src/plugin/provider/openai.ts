...
import type { IntegrationOAuthMethodRegistration } from "@privacycode-ai/plugin/v2/effect/integration"
import { define } from "@privacycode-ai/plugin/v2/effect/plugin"
...
function headers(contentType: string) {
  return { "Content-Type": contentType, "User-Agent": `privacycode/${InstallationVersion}` }
}
