...
import type { Data, Definition, Payload } from "@privacycode-ai/schema/event"
...
import { Durable } from "@privacycode-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@privacycode-ai/schema/event").ID
export type { Data, Definition, Payload } from "@privacycode-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/Event") {}
