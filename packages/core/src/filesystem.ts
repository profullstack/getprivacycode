...
import { Entry, FileSystem, FindInput, Match } from "@privacycode-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@privacycode-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/v2/FileSystem") {}
