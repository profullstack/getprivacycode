...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@privacycode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/v2/ToolRegistry") {}
