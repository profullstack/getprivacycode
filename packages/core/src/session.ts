...
import { ListAnchor } from "@privacycode-ai/schema/session"
...
import { SessionDurable } from "@privacycode-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/v2/Session") {}
