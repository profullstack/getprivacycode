...
export class Service extends Context.Service<Service, Interface>()("@privacycode/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.PRIVACYCODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
