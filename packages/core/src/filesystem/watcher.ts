...
import { FileSystemWatcher } from "@privacycode-ai/schema/filesystem-watcher"
...
declare const PRIVACYCODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof PRIVACYCODE_LIBC === "undefined" ? undefined : PRIVACYCODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.PRIVACYCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.PRIVACYCODE_EXPERIMENTAL_FILEWATCHER)) {
