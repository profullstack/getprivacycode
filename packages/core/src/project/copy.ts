...
import { Event } from "@privacycode-ai/schema/project-directories"
import { ProjectCopy } from "@privacycode-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/ProjectCopy") {}
