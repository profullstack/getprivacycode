...
import type { EffectDrizzleSqlite } from "@privacycode-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/ProjectDirectories") {}
