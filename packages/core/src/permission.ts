...
export { Effect, Rule, Ruleset } from "@privacycode-ai/schema/permission"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/v2/Permission") {}
