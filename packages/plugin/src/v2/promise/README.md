...
The Promise plugin API is the async/await equivalent of `@privacycode-ai/plugin/v2/effect`. It grants plugins the same two in-process capabilities:
...
```ts
import { define } from "@privacycode-ai/plugin/v2/promise"
