...
- Effect plugins import `@privacycode-ai/plugin/v2/effect`, not `@privacycode-ai/core`.
- Public domain values use generated `@privacycode-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@privacycode-ai/plugin/v2/effect`.
