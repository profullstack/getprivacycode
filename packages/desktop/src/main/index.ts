...
const TEST_ONBOARDING = process.env.PRIVACYCODE_TEST_ONBOARDING === "1"
...
const main = Effect.gen(function* () {
  ...
  process.env.PRIVACYCODE_DISABLE_EMBEDDED_WEB_UI = "true"
  ...
  const port = yield* Effect.gen(function* () {
    const fromEnv = process.env.PRIVACYCODE_PORT
    if (fromEnv) {
