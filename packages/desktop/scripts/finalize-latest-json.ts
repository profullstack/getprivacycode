...
const releaseId = process.env.PRIVACYCODE_RELEASE
if (!releaseId) throw new Error("PRIVACYCODE_RELEASE is required")

const version = process.env.PRIVACYCODE_VERSION
if (!version) throw new Error("PRIVACYCODE_VERSION is required")
