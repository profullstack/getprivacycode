import { OpenCode } from "@privacycode-ai/client/effect"
...
import { createEmbeddedRoutes } from "@privacycode-ai/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode-ai/sdk-next/OpenCode") {}
