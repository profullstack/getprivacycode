...
import defaultSoundPath from "@privacycode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@privacycode-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@privacycode-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@privacycode-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@privacycode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@privacycode-ai/ui/audio/yup-01.mp3" with { type: "file" }
