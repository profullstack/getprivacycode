import type { TuiPlugin, TuiPluginApi } from "@privacycode-ai/plugin/tui"
...
function View(props: { api: TuiPluginApi; sessionID: string }) {
  ...
  return (
    <box gap={1}>
      <Show when={show()}>
        ...
        >
          ...
          <box flexGrow={1} gap={1}>
            ...
            <text fg={theme().textMuted}>PrivacyCode includes free models so you can start immediately.</text>
      ...
      <text fg={theme().textMuted}>
        <span style={{ fg: theme().success }}>•</span> <b>PrivacyCode</b>
        {" "}
