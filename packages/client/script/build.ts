...
import { compile, emitEffectImported, emitPromise, write } from "@privacycode-ai/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@privacycode-ai/protocol/groups/event"',
            },
          },
        }),
