import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@privacycode-ai/sdk/v2"
import { SessionTurn } from "@privacycode-ai/session-ui/session-turn"
import { SessionReview } from "@privacycode-ai/session-ui/session-review"
import { DataProvider } from "@privacycode-ai/session-ui/context"
import { FileComponentProvider } from "@privacycode-ai/ui/context/file"
import { WorkerPoolProvider } from "@privacycode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@privacycode-ai/ui/logo"
import { IconButton } from "@privacycode-ai/ui/icon-button"
import { ProviderIcon } from "@privacycode-ai/ui/provider-icon"
import { iife } from "@privacycode-ai/core/util/iife"
...
import { MessageNav } from "@privacycode-ai/session-ui/message-nav"
import { FileSSR } from "@privacycode-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@privacycode-ai/session-ui/pierre/worker").then((m) => ({
