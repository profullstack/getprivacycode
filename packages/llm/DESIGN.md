...
> current private `@privacycode-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@privacycode-ai/ai`
...
import { LLM } from "@privacycode-ai/ai"
import { OpenAI } from "@privacycode-ai/ai/providers/openai"
...
```ts
import { Message } from "@privacycode-ai/ai"
...
import { LLM, Tool } from "@privacycode-ai/ai"
...
```ts
import { LLM } from "@privacycode-ai/ai/promise"
import { OpenAI } from "@privacycode-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@privacycode-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@privacycode-ai/ai/provider"
...
@privacycode-ai/ai/promise
  Promise/AsyncIterable LLM facade

@privacycode-ai/ai/schema
  serializable domain schemas

@privacycode-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@privacycode-ai/ai/providers/openai
@privacycode-ai/ai/providers/anthropic
@privacycode-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@privacycode-ai/llm`                      | `@privacycode-ai/ai`                                           |
