...
import { createOpencodeClient } from "@privacycode-ai/sdk/v2/client"
import { ServerAuth } from "@privacycode-ai/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/cli/Daemon") {}
