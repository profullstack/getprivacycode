...
Practical reference for the current tool-migration state in `packages/privacycode`.
...
Tool tests should use the existing Effect helpers in `packages/privacycode/test/lib/effect.ts`:
