...
import { SessionMessageTable } from "@privacycode-ai/core/session/sql"
...
import { Shell } from "@privacycode-ai/core/shell"
...
import { LocationServiceMap, locationServiceMapLayer } from "@privacycode-ai/core/location-services"
...
it.instance("does not loop empty assistant turns for a simple reply", () =>
  Effect.gen(function* () {
    ...
    yield* llm.text("packages/privacycode/src/session/processor.ts")
