...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders PRIVACYCODE_CALLER", () => {
    process.env["PRIVACYCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode PRIVACYCODE_CALLER", () => {
    process.env["PRIVACYCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown PRIVACYCODE_CALLER", () => {
    process.env["PRIVACYCODE_CALLER"] = "unknown"
