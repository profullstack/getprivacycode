...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      PRIVACYCODE_EXPERIMENTAL_WORKSPACES: Flag.PRIVACYCODE_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.PRIVACYCODE_EXPERIMENTAL_WORKSPACES = original.PRIVACYCODE_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
