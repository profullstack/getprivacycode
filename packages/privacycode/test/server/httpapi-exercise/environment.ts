...
export const exerciseConfigDirectory = path.join(exerciseGlobalRoot, "config", "privacycode")
export const exerciseDataDirectory = path.join(exerciseGlobalRoot, "data", "privacycode")
