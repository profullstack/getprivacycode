...
const originalWorkspaces = Flag.PRIVACYCODE_EXPERIMENTAL_WORKSPACES
...
afterEach(async () => {
  Flag.PRIVACYCODE_EXPERIMENTAL_WORKSPACES = originalWorkspaces
...
describe("session HttpApi", () => {
  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        const test = yield* TestInstance
        Flag.PRIVACYCODE_EXPERIMENTAL_WORKSPACES = true
