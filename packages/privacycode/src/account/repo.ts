...
import { AccountStateTable, AccountTable } from "@privacycode-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/AccountRepo") {}
