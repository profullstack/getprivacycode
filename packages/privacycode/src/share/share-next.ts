...
import type * as SDK from "@privacycode-ai/sdk/v2"
...
import { SessionShareTable } from "@privacycode-ai/core/share/sql"
...
const disabled = process.env["PRIVACYCODE_DISABLE_SHARE"] === "true" || process.env["PRIVACYCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/ShareNext") {}
