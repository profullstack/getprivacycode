...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@privacycode-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/ToolRegistry") {}
