...
import { ConfigMCPV1 } from "@privacycode-ai/core/v1/config/mcp"
...
import { McpEvent } from "@privacycode-ai/schema/mcp-event"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/MCP") {}
