...
import { ProjectDirectoryTable, ProjectTable } from "@privacycode-ai/core/project/sql"
import { ProjectDirectories } from "@privacycode-ai/core/project/directories"
...
import { which } from "@privacycode-ai/core/util/which"
...
import { AppProcess } from "@privacycode-ai/core/process"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.PRIVACYCODE_FAKE_VCS)
