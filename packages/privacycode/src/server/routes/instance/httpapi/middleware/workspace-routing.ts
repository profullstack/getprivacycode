...
>()("@privacycode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@privacycode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.PRIVACYCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.PRIVACYCODE_WORKSPACE_ID) : undefined
}
