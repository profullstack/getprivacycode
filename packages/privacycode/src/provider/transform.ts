...
import type * as ModelsDev from "@privacycode-ai/core/models-dev"
...
export function message(msgs: ModelMessage[], model: Provider.Model, options: Record<string, unknown>) {
  ...
  // Defender: tokenize sensitive data before it leaves the machine
  msgs = PrivacyGuard.get().tokenizeMessages(msgs)
