...
import { errorData, errorMessage } from "@privacycode-ai/tui/util/error"
...
import { hasTheme, upsertTheme } from "@privacycode-ai/tui/context/theme"
import { Global } from "@privacycode-ai/core/global"
import { Filesystem } from "@/util/filesystem"
import { Process } from "@/util/process"
import { Flock } from "@privacycode-ai/core/util/flock"
import { Flag } from "@privacycode-ai/core/flag/flag"
import { internalTuiPlugins, type InternalTuiPlugin } from "./internal"
import type { HostPluginApi, HostSlots } from "@privacycode-ai/tui/plugin/slots"
import { ConfigPlugin } from "@/config/plugin"
import { ConfigPluginV1 } from "@privacycode-ai/core/v1/config/plugin"
import { createCommandShim } from "@privacycode-ai/tui/plugin/command-shim"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Effect } from "effect"
import { createPluginRuntime, type PluginRuntime, type TuiPluginHost } from "@privacycode-ai/tui/plugin/runtime"
...
async function load(input: {
  ...
  try {
    ...
    const records = Flag.PRIVACYCODE_PURE ? [] : pluginOrigins
    if (Flag.PRIVACYCODE_PURE && pluginOrigins.length) {
    }
