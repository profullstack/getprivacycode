...
import { buildPrompt } from "@privacycode-ai/core/session/compaction"
import { SessionCompactionEvent } from "@privacycode-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/SessionCompaction") {}
