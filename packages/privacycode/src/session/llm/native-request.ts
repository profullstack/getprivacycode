import type { JsonSchema, LLMRequest, ProviderMetadata } from "@privacycode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@privacycode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @privacycode-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
