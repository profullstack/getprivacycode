...
import { llmClient } from "@privacycode-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@privacycode-ai/llm"
import { LLMClient } from "@privacycode-ai/llm/route"
import type { LLMClientService } from "@privacycode-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @privacycode-ai/llm. It
