 ...
 *   "@privacycode/ServerAuthConfig",
 *   {
 *     password: Config.string("PRIVACYCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("PRIVACYCODE_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
