...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@privacycode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@privacycode/ACPDirectory") {}
