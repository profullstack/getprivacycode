...
import { EventSequenceTable, EventTable } from "@privacycode-ai/core/event/sql"
...
import { WorkspaceEvent } from "@privacycode-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@privacycode/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        PRIVACYCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        PRIVACYCODE_WORKSPACE_ID: config.id,
        PRIVACYCODE_EXPERIMENTAL_WORKSPACES: "true",
