...
import type { Event, GlobalEvent, OpencodeClient } from "@privacycode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@privacycode/RunStreamTransport") {}
